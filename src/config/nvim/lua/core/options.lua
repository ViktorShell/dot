...
vim.o.scrolloff = 1000 -- Center always the current line to the center of the page (default: 0)
...
vim.o.timeoutlen = 450 -- Time to wait for a mapped sequence to complete (in milliseconds) (default: 1000)
