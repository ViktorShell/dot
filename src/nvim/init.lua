...
-- [[ Setting options ]]
-- NOTE: Setting options, check :help vim.opt and :help option-list
vim.opt.number = true
vim.opt.mouse = "a"
...
--  NOTE: Basic Keymaps, check :help vim.keymap.set()
vim.keymap.set("n", "<Esc>", "<cmd>nohlsearch<CR>")
vim.keymap.set("n", "<leader>q", vim.diagnostic.setloclist, { desc = "Open diagnostic Quickfix list" })

-- NOTE: Basic fast escape
...
-- [[ Basic Autocommands ]]
-- NOTE: Basic Autocommands, :help lua-guide-autocommands, help: vim.highlight.on_yank(), try 'yap' in NORMAL mode
